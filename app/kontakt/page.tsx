  ...
  return (
    <div className="">
      <div className="container mx-auto pt-28 pb-16 px-6 md:px-8 md:py-32 space-y-12 md:space-y-24">
        <h1 className="text-2xl md:text-5xl pl-2 md:px-32 text-primary font-bold">
          Kontakt Grad Mont
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          <div className=" mx-2 md:mx-20">
            <div className="space-y-3 md:space-y-10 text-lg md:text-2xl">
              ...
              <a
                href="viber://chat?number=%2B381603619391"
                className="py-[7px] flex border-b-[1px] border-primary"
              >
                <button className="hover:scale-110 transition-transform duration-500 px-4 md:px-8 flex gap-4 items-center">
              ...
              <a
                href="mailto:pavlecke@gmail.com"
                className="py-[7px] flex border-b-[1px] border-primary"
              >
                <button className="hover:scale-110 transition-transform duration-500 px-4 md:px-8 flex gap-4 items-center">
                  <Mail className=" w-[28px] h-[28px]" /> pavlecke@gmail.com
                </button>
              </a>
            </div>
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d65690.86035842249!2d20.28136426194083!3d45.01464907227221!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475af51cdcb1ddbb%3A0x9fe252bbb3c5d15a!2sNikole%20Marinkovi%C4%87a%2014%2C%20Belegi%C5%A1!5e0!3m2!1sen!2srs!4v1742943282732!5m2!1sen!2srs"
          width="600"
          height="450"
          style={{ border: "0" }}
          loading="lazy"
